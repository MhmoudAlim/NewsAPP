...
class NewsAdapter : RecyclerView.Adapter<NewsAdapter.ArticleViewHolder>() {
    ...
    //DifferCallback to update recyclerview changed items only on a background thread
    //instead of calling notifyDataSetChanged() which updates all items even the non changed and also blocks th UI thread
